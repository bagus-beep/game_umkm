...
const AUTH_CONFIG = {
  ...
  // API endpoint for validating/recording login
  API_URL: 'https://script.google.com/macros/s/AKfycbzoapuRNn9OeliSHt3s_DbdqbzDQ1YNntPFYZ-p5wbYeVbJXrmTlXJuuk-gJZ8kX8CQG2/exec',
